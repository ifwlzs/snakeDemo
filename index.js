...
var snake = null,
	...
	game = null,
	speed = 200,
	//初始速度：简单难度的速度为200，普通的速度为100，困难的速度为50
	speedVariance = 2;
//每个等级的速度差为2
...
//打开页面时判断本地是否有snakeHighScore的值，没有就手动赋值为0，有就显示到页面中
...
document.querySelector('#select1').onclick = function() {
	if(document.querySelector('#select1').selectedIndex == 0) {
		document.body.style.backgroundColor = "#cfe3ef";
		document.getElementById("snakeWrap").style.backgroundColor = "#225675"
		document.getElementById("snakeWrap").style.border = "20px solid #7dd9ff"
	}
	if(document.querySelector('#select1').selectedIndex == 1) {
		document.body.style.backgroundColor = "#FFCCCC";
		document.getElementById("snakeWrap").style.backgroundColor = "#996699"
		document.getElementById("snakeWrap").style.border = "20px solid #FF9999"
	}
}